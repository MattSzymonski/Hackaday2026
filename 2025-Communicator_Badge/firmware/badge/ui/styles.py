...
# Hackaday 2025 Communicator Badge original UI styles
...
lcd_color_bg      = lvgl.color_hex(0x171717)
lcd_color_fg      = lvgl.color_hex(0x26e600)
lcd_color_fg_dark = lvgl.color_hex(0x1a9e00)

hackaday_grey   = lvgl.color_hex(0x787878)
hackaday_yellow = lvgl.color_hex(0xe39810) ## adjusted for screen gamma
hackaday_white  = lvgl.color_hex(0xffffff)
...
lvg_color_black  	= lvgl.color_hex(0xa1a1a1)
